...
class Engine {
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            if (process.env.WITH_SNAPSHOT) {
                ...
                yield this.loadOrdersToRedis();
                yield this.updateOrderBook();
                yield this.loadUserBalancesToRedis();
                yield this.loadCryptoToRedis();
            }
        });
    }
    process(_a) {
        return __awaiter(this, arguments, void 0, function* ({ message, clientId }) {
            ...
            switch (message.type) {
                case "CREATE_ORDER": {
                    try {
                        const { executedQty, fills } = yield this.createOrder(message.data.market, message.data.price, message.data.quantity, message.data.side, message.data.userId);
                ...
                case "GET_DEPTH":
                    try {
                        ...
                        const orderbook = this.orderbooks.find((o) => (o === null || o === void 0 ? void 0 : o.ticker()) === market);
                        if (!orderbook) {
    ...
    createOrder(market, price, quantity, side, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { fills, executedQty } = yield orderbook.addOrder(order);
            logger_1.logger.info(`Added order ${fills} and quantity ${executedQty}`);
            yield Promise.all(fills.map((fill) => {
                return this.InitiateRedisTrades(fill.orderId, userId, fill.otherUserId, Number(fill.price), fill.quantity, fill.side, fill === null || fill === void 0 ? void 0 : fill.filled);
            }));
    ...
    InitiateRedisTrades(orderId, buyerUserId, sellerUserId, price, fillAmount, side, filled) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Input validation
                ...
                const result = yield exports.redis.evaluateTransaction(luaScript_1.OrderBuyScript, {
                    arguments: [
                        orderId,
                        buyerUserId,
                        sellerUserId,
                        ...
                        fillAmount.toString(),
                        side,
                        filled === null || filled === void 0 ? void 0 : filled.toString(),
                    ],
                });
    ...
    syncArraysWithRedisResult(result, orderId, price, side) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    loadUserBalancesToRedis() {
        return __awaiter(this, void 0, void 0, function* () {
            const accounts = yield postgres_prisma_1.default.accountBalance.findMany({});
            try {
    ...
    loadCryptoToRedis() {
        return __awaiter(this, void 0, void 0, function* () {
            const cryptos = yield postgres_prisma_1.default.cryptoBalance.findMany();
            if (!cryptos) {
                console.log(`No account found for user crypt`);
                return;
            }
            try {
                const loaded = yield Promise.all(cryptos.map((crypto) => {
                    var _a;
                    exports.redis.setHash(`crypto:${crypto.userId}`, {
                        [`${crypto.asset}_available`]: crypto === null || crypto === void 0 ? void 0 : crypto.quantity.toString(),
                        [`${crypto.asset}_locked`]: "0",
                        asset: crypto === null || crypto === void 0 ? void 0 : crypto.asset.toString(),
                        userId: crypto === null || crypto === void 0 ? void 0 : crypto.userId.toString(),
                        accountId: (_a = crypto === null || crypto === void 0 ? void 0 : crypto.accountId) === null || _a === void 0 ? void 0 : _a.toString(),
                    });
                }));
            }
            catch (error) {
    ...
    loadOrdersToRedis() {
        return __awaiter(this, void 0, void 0, function* () {
            const orders = yield postgres_prisma_1.default.orders.findMany({});
            if (!orders) {
            ...
            try {
                for (const order of orders) {
                    yield exports.redis.setHash(`order:${order.id}`, {
                        market: order.market,
                        side: order.side,
                        price: order.price.toString(),
                        quantity: order.quantity.toString(),
    ...
    updateOrderBook() {
        return __awaiter(this, void 0, void 0, function* () {
            for (let orderbook of this.orderbooks) {
                if ((orderbook === null || orderbook === void 0 ? void 0 : orderbook.baseAsset) === "SOL") {
                    orderbook.bids = [];
                    orderbook.asks = [];
                }
            }
            try {
                const keys = yield exports.redis.scanKeysStream();
                for (let key in keys) {
                    const data = yield exports.redis.getAllHashFields(keys[key]);
                    if (data.market === "SOL") {
                        for (let order of this.orderbooks) {
                            if ((order === null || order === void 0 ? void 0 : order.baseAsset) === data.market) {
                                if (data.side === "buy") {
                                    order.bids.push({
