            ...
            <div className="bg-[#222531] w-[55%] mr-[20px] h-[170px] my-2 rounded">
                <section className="flex w-full justify-between p-5">
                    <section className="flex items-center w-[180px] justify-between">
                        ...
                        <svg viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" height="1em" width="1em" className="sc-65e7f566-0 kALOHD c-i icon-certified" loading="lazy" decode="async" priority="low">
...
function Gain() {
    return (<>
        <svg viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" height="1em" width="1em" className="sc-65e7f566-0 krKQPk c-i" loading="lazy" decode="async" priority="low"><use href="#profit">
...
function Loss() {
    return (<>
        <svg viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" height="1em" width="1em" className="sc-65e7f566-0 gTxzHY c-i" loading="lazy" decode="async" priority="low">
            <use href="#lost">
